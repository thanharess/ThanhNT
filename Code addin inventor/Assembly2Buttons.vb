...
tối đa 3 lever & không copy vào cụm lắp. chỉ copy part", Ass2SmallIcon12, Ass2LargeIcon12)
            ...
            Dim assemblyBtna16 As ButtonDefinition = controlDefs.AddButtonDefinition("Assembly Action 16", "ThanhN_Assembly_Btna16", CommandTypesEnum.kShapeEditCmdType, addInClientID, Nothing, Nothing, Ass2SmallIcon16, Ass2LargeIcon16)
            ...
            Dim assemblyBtna17 As ButtonDefinition = controlDefs.AddButtonDefinition("Assembly Action 17", "ThanhN_Assembly_Btna17", CommandTypesEnum.kShapeEditCmdType, addInClientID, Nothing, Nothing, Ass2SmallIcon17, Ass2LargeIcon17)
