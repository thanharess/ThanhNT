...
#Region "constrain"
            ...
            Dim assemblyBtn28 As ButtonDefinition = controlDefs.AddButtonDefinition("Constrain, Ground, Delete", "ToolInventor2020_Assembly_Btn28", CommandTypesEnum.kShapeEditCmdType, addInClientID,
            ...
            Dim assemblyBtn1 As ButtonDefinition = controlDefs.AddButtonDefinition("Suppress,constrain,Ground", "ToolInventor2020_Assembly_Btn1", CommandTypesEnum.kShapeEditCmdType, addInClientID,
                                                                                   Nothing,
            ...
            Dim assemblyBtn2 As ButtonDefinition = controlDefs.AddButtonDefinition("Constrain Keep position", "ToolInventor2020_Assembly_Btn2", CommandTypesEnum.kShapeEditCmdType, addInClientID,
                                                                                   Nothing,
            ...
            Dim assemblyBtn3 As ButtonDefinition = controlDefs.AddButtonDefinition("Constrain về gốc 2 chi tiết", "ToolInventor2020_Assembly_Btn3", CommandTypesEnum.kShapeEditCmdType, addInClientID,
            ...
            Dim assemblyBtn4 As ButtonDefinition = controlDefs.AddButtonDefinition("Constrain all to select", "ToolInventor2020_Assembly_Btn4", CommandTypesEnum.kShapeEditCmdType, addInClientID,
                                                                                   Nothing,
            ...
            Dim assemblyBtn16 As ButtonDefinition = controlDefs.AddButtonDefinition("Hiện gốc tọa độ để Constrain", "ToolInventor2020_Assembly_Btn16", CommandTypesEnum.kShapeEditCmdType, addInClientID,
...
#Region "BTVT Assembly"
            ...
            Dim assemblyBtn5 As ButtonDefinition = controlDefs.AddButtonDefinition("Lọc tấm, mua, Standard", "ToolInventor2020_Assembly_Btn5", CommandTypesEnum.kShapeEditCmdType, addInClientID, Nothing, Nothing, ass1SmallIcon5, ass1LargeIcon5)
